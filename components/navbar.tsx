...
export function MobileNavbar() {
  return (
    <>
      <nav className="fixed left-0 right-0 top-0 z-50 flex items-center justify-between bg-background px-4 py-2 md:hidden">
        ...
        <div className="flex items-center gap-4">
          <InputGroup className="rounded-full border-none bg-accent py-4 shadow-none">
