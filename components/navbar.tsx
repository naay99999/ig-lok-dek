...
import { Home, Heart, MessageCircle, Plus, Compass, PlaySquare, Send, SearchIcon } from "lucide-react"
...
export function MobileNavbar() {
  return (
    <>
      {/* Mobile Top Bar */}
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between bg-background px-4 py-2 md:hidden">
        ...
        <div className="flex items-center gap-4">
          <InputGroup className="bg-accent border-none rounded-full shadow-none py-4">
